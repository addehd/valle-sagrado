...
<article
	class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 cursor-pointer {sizeClasses[size]} overflow-hidden border border-gray-100"
	role="button"
	tabindex="0"
