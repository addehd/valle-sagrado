    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        {#each data.cartItems as item (item.id)}
          <div class="p-6 flex items-center space-x-4">
            ...
            <div class="flex-shrink-0">
              <a href="/rikuy/{projectSlug}/product/{item.products?.slug || item.product_sku}">
                <img 
            ...
            <div class="flex-1 min-w-0">
              <h3 class="text-lg font-medium text-gray-900 truncate">
                <a 
                  href="/rikuy/{projectSlug}/product/{item.products?.slug || item.product_sku}"
      ...
      <div class="bg-gray-50 px-6 py-4">
        ...
        <div class="flex space-x-4">
          ...
          <a
            href="/rikuy/{projectSlug}/checkout"
