		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
			...
			<nav class="mb-8" aria-label="Breadcrumb">
				<ol class="flex items-center space-x-2 text-sm text-gray-600">
					<li><a href="/rikuy/{projectSlug}" class="hover:text-gray-900">Home</a></li>
					<li class="flex items-center">
						<svg class="w-4 h-4 mx-2" fill="currentColor" viewBox="0 0 20 20">
							<path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
						</svg>
						<a href="/rikuy/{projectSlug}/categories" class="hover:text-gray-900">Categories</a>
					</li>
					{#if parentCategory}
						<li class="flex items-center">
							<svg class="w-4 h-4 mx-2" fill="currentColor" viewBox="0 0 20 20">
							...
							<a href="/rikuy/{projectSlug}/categories/{parentCategory.slug}" class="hover:text-gray-900">{parentCategory.name}</a>
						</li>
					{/if}
					<li class="flex items-center">
						<svg class="w-4 h-4 mx-2" fill="currentColor" viewBox="0 0 20 20">
