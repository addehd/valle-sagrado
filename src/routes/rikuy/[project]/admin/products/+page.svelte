<script lang="ts">
	...
	function getProductViewUrl(product: Product): string {
		...
		return `/rikuy/${project.url}/product/${product.slug || product.sku}`;
	}
</script>
...
<main class="container mx-auto px-6 py-12 max-w-7xl">
	<div class="flex items-center justify-between mb-8">
		...
		<a href="{adminBase}/products/create" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
			+ Add New Product
		</a>
	</div>
		...
		<div class="bg-white rounded-lg shadow overflow-hidden">
			...
			{#if filteredProducts.length === 0}
				<div class="text-center py-12">
					...
					<a href="{adminBase}/products/create" class="text-blue-600 hover:text-blue-700 mt-2 inline-block">
							...
							{#each filteredProducts as product}
								<tr class="hover:bg-gray-50">
									...
									<td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
										<button
											on:click={() => goto(`${adminBase}/products/${product.sku}/edit`)}
