	...
	<main class="container mx-auto px-6 py-12 max-w-4xl">
		<div class="flex items-center justify-between mb-8">
			...
			<div class="flex gap-3">
				<a href="{adminBase}/products" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
					← Back to Products
				</a>
				<a href="/rikuy/{projectSlug}/product/{slug || sku}" target="_blank" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
					View Product
				</a>
			</div>
		</div>
		...
		<form on:submit|preventDefault={handleSubmit} class="space-y-6">
			...
			<div class="flex justify-between items-center pt-6">
				...
				<div class="flex gap-3">
					<a href="{adminBase}/products" class="px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
						Cancel
					</a>
					<button
						type="submit"
