...
<svelte:head>
	<title>Admin Dashboard | {project?.name || 'Valle Sagrado'}</title>
</svelte:head>
...
<main class="container mx-auto px-6 py-12 max-w-6xl">
	...
	<div class="bg-white rounded-lg shadow p-6 mb-8">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
			<a href="{adminBase}/products/create" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
			...
			<a href="{adminBase}/products" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
			...
			<a href="{adminBase}/orders" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
			...
			<a href="{adminBase}/csv-upload" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
				<svg class="w-8 h-8 text-orange-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
				</svg>
				<div>
					<h3 class="font-medium text-gray-900">CSV Upload</h3>
					<p class="text-sm text-gray-500">Bulk import products</p>
				</div>
			</a>
		</div>
	</div>
