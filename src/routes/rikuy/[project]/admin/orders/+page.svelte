...
<svelte:head>
	<title>Order Management | Admin | {project?.name || 'Valle Sagrado'}</title>
</svelte:head>
...
<main class="container mx-auto px-6 py-8 max-w-7xl">
	<div class="flex items-center justify-between mb-8">
		...
		<a href={adminBase} class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
			← Back to Dashboard
		</a>
	</div>
							...
							<tr class="hover:bg-gray-50">
								...
								<td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
									<div class="flex items-center space-x-2">
										...
										<button
											on:click={() => goto(`${adminBase}/orders/${order.id}`)}
