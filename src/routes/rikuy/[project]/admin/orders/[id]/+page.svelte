...
<svelte:head>
	<title>Order #{order?.order_number || orderId} | Admin | {project?.name || 'Valle Sagrado'}</title>
</svelte:head>
...
<main class="container mx-auto px-6 py-8 max-w-7xl">
	<div class="flex items-center justify-between mb-8">
		...
		<div class="flex items-center space-x-3">
			<a href="{adminBase}/orders" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
				← Back to Orders
			</a>
		</div>
	</div>
